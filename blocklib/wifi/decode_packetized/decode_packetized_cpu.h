...
#include <gnuradio/wifi/decode_packetized.h>
...
class decode_packetized_cpu : public virtual decode_packetized
{
public:
    decode_packetized_cpu(block_args args);
    int crc_cnt = 0;
private:
    void decode();
    void deinterleave();
    ...
    virtual void handle_msg_pdus(pmtf::pmt msg);
                ...
                ofdm_param& ofdm_info)
    {
        ...
        // // create PDU
        // pmtf::pmt blob = pmt::make_blob(out_bytes + 2, frame_info.psdu_size -
