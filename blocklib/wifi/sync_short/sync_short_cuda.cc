...
#include "sync_short_cuda.h"
#include "sync_short_cuda_gen.h"
...
sync_short_cuda::sync_short_cuda(block_args args) : INHERITED_CONSTRUCTORS,
      d_min_plateau(args.min_plateau),
      d_threshold(args.threshold)

{
    sync_short_cu::get_block_and_grid(&d_min_grid_size, &d_block_size);
