...
class WIFI_API constellation_bpsk : virtual public constellation
{
public:
...
class WIFI_API constellation_qpsk : virtual public grk::digital::constellation
{
public:
...
class WIFI_API constellation_16qam : virtual public grk::digital::constellation
{
public:
...
class WIFI_API constellation_64qam : virtual public grk::digital::constellation
{
public:
